...
const Hero = () => {
  return (
    <div className='container'>
      ...
      <div className="row p-5 border-top mt-5 " style={{lineHeight:"1.8rem"}} >
...
<p className='text-muted'><a href="" style={{textDecoration:"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
<p className='text-muted '>
